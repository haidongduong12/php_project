    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="{{ Storage::url('images/' . $product->product_image) }}"
                            alt="Image">
                    </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <h3 class="font-weight-semi-bold mb-4">{{ number_format($product->product_price, 0, ',', '.') }} VND
                </h3>
                ...
                <div class="d-flex mb-4">
                    <strong class="text-dark mr-3">In stock:</strong>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    @if (isset(Auth::user()->id))
                        {{-- <a href="action="{{ route('cart.store') }}" class="btn btn-primary px-3"><i
                        ...
                        <form action="{{ route('cart.store') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary px-5 m-2">
                                <i class="fa-solid fa-store mr-1"></i>Shop now
                            </button>
                        </form>
                    @else
            ...
            <div class="bg-light p-30">
                <div class="nav nav-tabs mb-4">
                    @if (Route::has('login'))
                        ...
                        @else
                            <a class="nav-item nav-link text-dark active" href="{{ route('login') }}">Description</a>
                            <a class="nav-item nav-link text-dark" href="{{ route('login') }}">Information</a>
                            <a class="nav-item nav-link text-dark" href="{{ route('login') }}">Reviews
                                (0)
                            </a>
                        @endauth
                    @endif
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-4">{{ count($comments) }} review for "{{ $product->product_name }}"
                                </h4>
                                    ...
                                    <div class="media-body">
                                        @if (isset($comments) && count($comments) > 0)
                                            @foreach ($comments as $items)
                                                <h6>{{ $items->user->username }}<small> -
                                                        <i>{{ $items->formatted_created_at }}</i></small>
                                                </h6>
                                ...
                                <form action="{{ route('comment.add') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name"
                                            value="{{ Auth::user()->username }}" disabled name="username">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100"
                                    src="{{ Storage::url('images/' . $items->product_image) }}" alt="">
                                <div class="product-action">
                                    <a href="{{ route('productDetails', ['id' => $items->id]) }}"
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate"
                                    href="{{ route('productDetails', ['id' => $items->id]) }}">{{ $items->product_name }}</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{ $items->product_price * 0.85 }}</h5>
                                    <h6 class="text-muted ml-2"><del>{{ $items->product_price }}</del></h6>
                                </div>
