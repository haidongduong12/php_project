...
<body class="">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    ...
                    <form action="{{ route('searchDashProduct') }}" method="GET">
                        @csrf
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mt-2">ADD NEW PRODUCTS</h5>
                        </div>

                        <a href="{{ route('products.create') }}" class="btn btn-primary m-20">Add </a>
                    </div>
                ...
                {{-- <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>Inverse Table</h5>
                            <span class="d-block m-t-5">use class <code>table-inverse</code> inside table
                                element</span>
                        </div>
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                        ...
                        <div class="card-body table-border-style">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <img style="max-width: 100px;"
                                                            src="{{ Storage::url('images/' . $product->product_image) }}">
                                                    </td>
                                                    <td>{{ number_format($product->product_price, 0, ',', '.') }} VND
                                                    </td>
                            ...
                            <div class="pagination justify-content-center">
                                ...
                                @if ($products->hasMorePages())
                                    <a href="{{ $products->nextPageUrl() }}" class="btn btn-secondary"
                                        rel="next">&raquo;</a>
                                @else
                ...
                {{-- <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Striped Table</h5>
                            <span class="d-block m-t-5">use class <code>table-striped</code> inside table
                                element</span>
                        </div>
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                ...
                {{-- <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="d-block m-t-5">Regular table background variants are not available with the
                                inverse table, however, you may use <code>text or background utilities</code> to achieve
                                similar styles.</span>
                        </div>
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
    ...
    <div class="fixed-button active"><a
            ...
            target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
