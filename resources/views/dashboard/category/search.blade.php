...
@section('search')
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            @if (isset($cateSearch) && count($cateSearch) > 0)
                                <?php $i = 1; ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <img style="max-width: 100px;"
                                                    src="{{ Storage::url('images/' . $category->category_image) }}">
                                            </td>
                                            <td>
    ...
    @else
        <div class="alert alert-warning alert-dismissible fade show col-xl-12" role="alert">
            No categories found!
