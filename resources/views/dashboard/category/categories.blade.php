        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    ...
                    <form action="{{ route('searchDashCate') }}" method="GET">
                        @csrf
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <img style="max-width: 100px;"
                                                            src="{{ Storage::url('images/' . $items->category_image) }}">
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('categories.edit', $items->id) }}"
                                                            class="btn btn-warning"><i class="fa-solid fa-pen"
                                                                style="color:white;"></i></a>
                                                        <form action="{{ route('categories.destroy', $items->id) }}"
