                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mt-2">ADD NEW BRANDS</h5>
                        </div>

                        <a href="{{ route('brands.create') }}" class="btn btn-primary m-20">Add </a>
                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <img style="max-width: 100px;"
                                                            src="{{ Storage::url('images/' . $items->image) }}">
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('brands.edit', $items->id) }}"
                                                            class="btn btn-warning"><i class="fa-solid fa-pen"
                                                                style="color:white;"></i></a>
                                                        <form action="{{ route('brands.destroy', $items->id) }}"
