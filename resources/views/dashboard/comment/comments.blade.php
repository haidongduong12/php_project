                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li><a href="{{ route('comment.showDash') }}">Orders</a></li>
                        </ul>
                    </li>
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    ...
                    <form action="{{ route('searchDashUser') }}" method="GET">
                        @csrf
                ...
                {{-- <div class="col-md-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mt-2">ADD NEW USERS</h5>
                        </div>

                        <a href="{{ route('users.create') }}" class="btn btn-primary m-20">Add </a>
                    </div>
                                        ...
                                        @foreach ($comments as $items)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $items->status }}</td>
                                                    <td>
                                                        <a href="{{ route('comments.edit', $items->id) }}"
                                                            class="btn btn-warning"><i class="fa-solid fa-pen"
                                                                style="color:white;"></i></a>
                                                        <form action="{{ route('comments.destroy', $items->id) }}"
